    ...
    \section{Results}
        \subsection[Question 1]{What are the typical patterns in the prox card data? What does a typical day look like for GAStech employees?}
            ...
            \subsubsection{Workflow}
                With the general information of prox data, we have decided our workflow for question 1 or section \ref{sec:question1} as figure \ref{fig:workflow1}.
                
                \begin{figure}[htbp]
                    \centering
                    \begin{tikzpicture}[node distance = 2cm, auto]
                        \node[cloud](root1){Divide the employees};
                        
                        \node[decision, below of=root1, left of=root1](div1){By percentile};
                        \path [line] (root1) -- (div1); 
                        
                        \node[block, below=1cm of div1](find1){Movement Direction and Distance};
                        \path [line] (div1) -- (find1);
                        
                        \node[decision, below of=root1, right of=root1](div2){By departments};
                        \path [line] (root1) -- (div2);
                        
                        \node[block, below=1cm of div2](find2){Departemnt Distribution from \% to \%};
                        \path [line] (div2) -- (find2);
                        
                        \node[cloud, below=8cm of root1](con1){Find Patterns};
                        \path [line] (find1) -- (con1);
                        \path [line] (find2) -- (con1);
            ...
            \subsubsection{Typical Day Look for GAStech employees}
                ...
                \begin{figure}[htbp]
                    \centering
                    $\begin{array}{cc}
                        \includegraphics[width=0.4 \linewidth]{figures/percentile1.png}
                        &
                        \includegraphics[width=0.4 \linewidth]{figures/percentile2.png}
                        \\
                        \mbox{(a) 0\%-25\%} & \mbox{(b) 25\%-50\%} \\
                        
                        \includegraphics[width=0.4 \linewidth]{figures/percentile3.png}
                        &
                        \includegraphics[width=0.4 \linewidth]{figures/percentile4.png}
                        \\
                        \mbox{(c) 50\%-75\%} & \mbox{(d) 75\%-100\%} \\
                    \end{array}$
                    \caption{Movement Distribution by Percentile on Second Floor}
                    \label{fig:second}
                \end{figure}
        ...
        \subsection[Question 2]{Describe up to five of the most interesting patterns that appear in the building data. Describe what is notable about the pattern and explain its possible significance.}
            ...
            \subsubsection{Workflow}
                We have decided our workflow for question 2 or section \ref{sec:question2} as figure \ref{fig:workflow2}.
                \begin{figure}[htbp]
                    \centering
                    \begin{tikzpicture}[node distance = 2cm, auto]
                        \node[cloud](root2){How to find Pattern?};
                        
                        \node[block, left of=root2, below of=root2, text width=0.2 \linewidth](way201){Correlation within General Data};
                        \path [line] (root2) -- (way201);
                        
                        \node[cloud, left of=way201, below of=way201](way203){\(R < 0\)};
                        \path [line] (way201) -- (way203);
                        
                        \node[cloud, right of=way201, below of=way201](way204){\(R > 0\)};
                        \path [line] (way201) -- (way204);
                        
                        \node[block, below of=way204](way205){Many \(R = 1\)};
                        \path [line] (way204) -- (way205);
                        
                        \node[block, right of=root2, below of=root2](way202){Divide into Quarters};
                        \path [line] (root2) -- (way202);
                        
                        \node[cloud, below of=way202](way206){First Q.};
                        \node[cloud, right of=way206](way207){Second Q.};
                        \node[cloud, right of=way207](way208){Third Q.};
                        \node[cloud, right of=way208](way209){Fourth Q.};
                        \path [line] (way202) -- (way206);
                        \path [line] (way202) -- (way207);
                        \path [line] (way202) -- (way208);
                        \path [line] (way202) -- (way209);
                        
                        \node[block, below of=way206](way210){Cycle};
                        \path [line] (way206) -- (way210);
                        \path [line] (way208) -- (way210);
                        
                        \node[cloud, below of=way210](way213){Period};
                        \path [line] (way210) -- (way213);
                        
                        \node[block, below of=way209, text width=0.2 \textwidth](way211){Peak/Under Peak};
                        \path [line] (way207) -- (way211);
                        \path [line] (way209) -- (way211);
                        
                        \node[cloud, below of=way211](way214){Widths of Peaks};
                        \path [line] (way211) -- (way214); 
                        
                        \node[decision, below of=way213](way215){Pattern?};
                        \path [line] (way203) -- (way215);
                        \path [line] (way205) -- (way215);
                        \path [line] (way213) -- (way215);
                        \path [line] (way214) -- (way215);
                    \end{tikzpicture}
        ...
        \subsection[Question 3]{Describe up to five notable anomalies or unusual events you see in the data. Prioritize those issue that are most likely to represent a danger or a serious issue for building operations.}
            ...
            \subsubsection{Workflow}
                We have decided our workflow for question 3 or section \ref{sec:question3} as figure \ref{fig:workflow3}.
                \begin{figure}[htbp]
                    \centering
                    \begin{tikzpicture}[node distance = 2cm, auto]
                        \node[decision](way301){Normal?};
                        
                        \node[cloud, left of=way301, below of=way301](way302){OneClassSVM};
                        \node[cloud, right of=way301, below of=way301](way303){IsolationForest};
                        \node[cloud, left=1cm of way302](way304){Elliptic};
                        \node[cloud, right=1cm of way303](way305){LocalOutlier};
                        \path [line] (way301) -- (way302);
                        \path [line] (way301) -- (way303);
                        \path [line] (way301) -- (way304);
                        \path [line] (way301) -- (way305);
                        
                        \node[decision, below=2cm of way301](way306){Best?};
                        \path [line] (way302) -- (way306);
                        \path [line] (way303) -- (way306);
                        \path [line] (way304) -- (way306);
                        \path [line] (way305) -- (way306);
                        
                        \node[cloud, below of=way306](way307){DecisionTree};
                        \node[cloud, left=1cm of way307](way308){SVC};
                        \node[cloud, left=1cm of way308](way309){KNeighbor};
                        \node[cloud, right=1cm of way307](way310){RandomForest};
                        \node[cloud, right=1cm of way310](way311){AdaBoost};
                        \path [line] (way306) -- (way307);
                        \path [line] (way306) -- (way308);
                        \path [line] (way306) -- (way309);
                        \path [line] (way306) -- (way310);
                        \path [line] (way306) -- (way311);
                        
                        \node[block, below of=way307, text width=0.2 \linewidth](way312){LocalOutlier};
                        \path [line] (way307) -- (way312);
                        \path [line] (way308) -- (way312);
                        \path [line] (way309) -- (way312);
                        \path [line] (way310) -- (way312);
                        \path [line] (way311) -- (way312);
                        
                        \node[block, below of=way312](way313){Divide into};
                        \path [line] (way312) -- (way313);
                        
                        \node[cloud, left of=way313, below of=way313](way314){Normal};
                        \node[cloud, right of=way313, below of=way313](way315){Abnormal};
                        \path [line] (way313) -- (way314);
                        \path [line] (way313) -- (way315);
                        
                        \node[decision, below=3cm of way313](way316){\(\Delta\)Mean?};
                        \path [line] (way314) -- (way316);
                        \path [line] (way315) -- (way316);
                        
                        \node[block, below of=way316](way317){Correlation};
                        \path [line] (way316) -- (way317);
                    \end{tikzpicture}
        ...
        \subsection[Question 4]{Describe up to three observed relationships between the proximity card data and building data elements. If you find a causal relationship, describe your discovered cause and effect, the evidence you found the support it, and your level of confidence in your assessment of the relationship.}
            ...
            \subsubsection{Workflow}
                We have decided our workflow for question 4 or section \ref{sec:question4} as figure \ref{fig:workflow4}.
                \begin{figure}[htbp]
                    \centering
                    \begin{tikzpicture}[node distance = 2cm, auto]
                        \node[decision](way401){Normal?};
                        
                        \node[cloud, left of=way401, below of=way401](way402){OneClassSVM};
                        \node[cloud, right of=way401, below of=way401](way403){IsolationForest};
                        \node[cloud, left=1cm of way402](way404){Elliptic};
                        \node[cloud, right=1cm of way403](way405){LocalOutlier};
                        \path [line] (way401) -- (way402);
                        \path [line] (way401) -- (way403);
                        \path [line] (way401) -- (way404);
                        \path [line] (way401) -- (way405);
                        
                        \node[decision, below=2cm of way401](way406){Best?};
                        \path [line] (way402) -- (way406);
                        \path [line] (way403) -- (way406);
                        \path [line] (way404) -- (way406);
                        \path [line] (way405) -- (way406);
                        
                        \node[cloud, below of=way406](way407){DecisionTree};
                        \node[cloud, left=1cm of way407](way408){SVC};
                        \node[cloud, left=1cm of way408](way409){KNeighbor};
                        \node[cloud, right=1cm of way407](way410){RandomForest};
                        \node[cloud, right=1cm of way410](way411){AdaBoost};
                        \path [line] (way406) -- (way407);
                        \path [line] (way406) -- (way408);
                        \path [line] (way406) -- (way409);
                        \path [line] (way406) -- (way410);
                        \path [line] (way406) -- (way411);
                        
                        \node[block, below of=way407, text width=0.2 \linewidth](way412){LocalOutlier};
                        \path [line] (way407) -- (way412);
                        \path [line] (way408) -- (way412);
                        \path [line] (way409) -- (way412);
                        \path [line] (way410) -- (way412);
                        \path [line] (way411) -- (way412);
                        
                        \node[block, below of=way412, text width=0.2 \linewidth](way413){Select Abnormal};
                        \path [line] (way412) -- (way413);
                        
                        \node[block, below of=way413](way414){Correlation?};
                        \path [line] (way413) -- (way414);
                    \end{tikzpicture}
