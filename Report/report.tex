...
\begin{document}
    ...
    \section{Results}
        \subsection[Question 1]{What are the typical patterns in the prox card data? What does a typical day look like for GAStech employees?}
            ...
            Hence, we divided prox data into four sub-group by percentile. Also, we drew the plot about movement direction and distance with each sub-group. 
            ...
            The movement direction and distance on the first floor is shows as figure \ref{fig:movedd1}. 
