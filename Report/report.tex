    ...
    \section{Results}
        ...
        \subsection[Question 2]{Describe up to five of the most interesting patterns that appear in the building data. Describe what is notable about the pattern and explain its possible significance.}
            ...
            \subsubsection{Plots of General Building Data}
                ...
                In the first-quarter, we find that the general building data make a cycle \textit{every 288 indices} as figure \ref{fig:firstq}. The general building data are reported on every 5 minutes, so the general building data make a cycle every 1440 minutes or 24 hours or 1 day. 
